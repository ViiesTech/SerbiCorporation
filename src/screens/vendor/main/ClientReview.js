  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <LineBreak val={2} />
        <AppText color="#494949" align="center" title={reviewData?.message} />
        <LineBreak val={1} />
        ...
        <AppText
          fontWeight="bold"
          color={'#000'}
          title={'-' + ' ' + reviewData?.userId?.fullName}
          align="center"
        />
        <View
          style={{
        ...
        >
          <StarRatingDisplay rating={reviewData?.star} />
